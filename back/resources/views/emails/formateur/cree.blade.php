...
<body>
    <div class="container">
        ...
        <div class="section">
            <p>Bonjour <strong>{{ $formateur->user->prenom }} {{ $formateur->user->nom }}</strong>,</p>
            <p>Votre compte formateur a été créé avec succès. Voici vos informations de connexion :</p>
        </div>

        <div class="section identifiants">
            <h3>🔐 Vos identifiants</h3>
            <p><strong>Email :</strong> {{ $formateur->user->email }}</p>
        ...
        <div class="section modules">
            <h3>📦 Modules qui vous sont assignés</h3>
        ...
        <div class="footer1">
            <p>2026 2i OnLine - Incub Institut, Bargny, Senegal.</p>
        </div>
